...
- (instancetype)initWithFileURL:(NSURL *)fileURL isReadyToPlay:(BOOL)isReadyToPlay thumbnailImage:(UIImage *)thumbnailImage //cachedVideoImageView:(UIImage *)cachedVideoImageView
{
    self = [super init];
    if (self) {
...
//- (void)thumbnailImage:(UIImage *)thumbnailImage
//{
//    _thumbnailImage = [_thumbnailImage copy];
//    _cachedVideoImageView = nil;
//}
...
- (UIView *)mediaView
{
    ...
    if (self.cachedVideoImageView == nil) {
        ...
        UIImage *playIcon = [[UIImage jsq_defaultPlayImage] jsq_imageMaskedWithColor:[UIColor orangeColor]];
...
- (instancetype)copyWithZone:(NSZone *)zone
{
    JSQVideoMediaItem *copy = [[[self class] allocWithZone:zone] initWithFileURL:self.fileURL
                                                                   isReadyToPlay:self.isReadyToPlay thumbnailImage:self.thumbnailImage];// cachedVideoImageView:self.cachedVideoImageView];
