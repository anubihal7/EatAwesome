...
class MultiPickerDialog: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    private func createContainerView() -> UIView {
        ...
        // ˆˆˆ
        vv = UIView(frame: CGRect.init(x: 0, y: 0, width: 350, height: 70))
               vv.backgroundColor = kpurpleTheme
        dialogContainer.addSubview(vv)

        //Title
        self.titleLabel = UILabel(frame: CGRect.init(x: 10, y: 10, width: 340, height: 60))
        self.titleLabel.textAlignment = NSTextAlignment.left
        self.titleLabel.text = "Hi \(AppDefaults.shared.userName), how can we help you today?"
        self.titleLabel.textColor = UIColor.white
        self.titleLabel.font = UIFont(name: "AvenirNext-Bold", size: 18)
        // self.titleLabel.sizeToFit()
        self.titleLabel.numberOfLines = 2
       //  self.titleLabel.backgroundColor = kpurpleTheme
      // self.titleLabel.frame.size = self.titleLabel.bounds.size
        dialogContainer.addSubview(self.titleLabel)
        
       
        
        self.picker = UITableView(frame: CGRect.init(x: 0, y: 60, width: 10, height: 10))
        ...
        self.picker.frame.size.width = 350
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let theCell = cell!
           theCell.textLabel?.numberOfLines = 2
