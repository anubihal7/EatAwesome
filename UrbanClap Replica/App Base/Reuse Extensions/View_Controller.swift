...
extension UIViewController: NVActivityIndicatorViewable
{
   ...
   func getCartCount() -> String
   {
    ...
    func getDeliveryTypeStatus() -> String
    {
        ...
        {
            status = AppDefaults.shared.deliveryTypeForBoth
        }
    ...
    func addBadge(itemvalue: String)
    {
        ...
        bagButton.tintColor = UIColor.lightGray
    ...
    //MARK:- ConvertImage into Base64
      ...
      //MARK: - GallaryCamera Actionc
      func OpenGallery(pickerController : UIImagePickerController,imagePicker_Delegate:UIImagePickerDelegate){
          imagePickerDelegate = imagePicker_Delegate;
      ...
      func OpenCamera(pickerController : UIImagePickerController,imagePicker_Delegate:UIImagePickerDelegate)
      {
          imagePickerDelegate = imagePicker_Delegate;
                                      ...
                                      //  pickerController.delegate = self //as? UIImagePickerControllerDelegate & UINavigationControllerDelegate
                                        DispatchQueue.main.async {
                                              pickerController.sourceType = UIImagePickerController.SourceType.camera
                                                                                  pickerController.allowsEditing = true//kUTTypeImage
                                                                                  pickerController.mediaTypes = [kUTTypeImage as String]
                                            pickerController.title  = "Media"
                                                                                  self.present(pickerController, animated: true, completion: nil)
                                        }
      ...
      func OpenGallaryCamera(pickerController : UIImagePickerController,imagePicker_Delegate:UIImagePickerDelegate)
      {
          imagePickerDelegate = imagePicker_Delegate;
