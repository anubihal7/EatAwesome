...
class SliderStep: UISlider {
    ...
    @IBInspectable var stepTickColor: UIColor = UIColor.darkGray
    @IBInspectable var stepTickRounded: Bool = true
    @IBInspectable var unselectedFont: UIFont = UIFont.systemFont(ofSize: 8)
    @IBInspectable var selectedFont: UIFont = UIFont.systemFont(ofSize: 8)
    @IBInspectable var stepTitlesOffset: CGFloat = 1
    @IBInspectable var highlightedImageSize: CGFloat = 25
    @IBInspectable var selectedColor: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
    @IBInspectable var unselectedColor: UIColor = UIColor.darkGray
